...
class AdminController extends Controller {
    ...
    public function productEdit(): void {
        ...
        $skus = $this->productModel->getSkus($id);
    ...
    private function getSiteCurrency(): string {
        return normalize_currency_code($this->settingModel->get('site_currency', 'USD'), 'USD');
    }

    private function handleProductPricing(int $productId, string $priceMode): void {
        if ($priceMode === 'sku') {
            $this->productModel->saveSkus($productId, normalize_product_skus($_POST));
            return;
        }
    ...
    private function contentConfig(string $type): array
    {
        ...
        $configs = [
            'post' => [
                ...
                'preview_base' => '/blog/',
                'icon' => 'newspaper',
                'header_style' => 'background: #059669; box-shadow: 0 10px 40px rgba(15, 23, 42, 0.12);',
                ...
                'primary_button_class' => 'bg-indigo-600 shadow-lg shadow-indigo-500/25',
            ...
            'case' => [
                ...
                'preview_base' => '/case/',
                'icon' => 'briefcase',
                'header_style' => 'background: #0891b2; box-shadow: 0 10px 40px rgba(15, 23, 42, 0.12);',
            ...
            'page' => [
                ...
                'preview_base' => '/page/',
                'icon' => 'file-lines',
                'header_style' => 'background: #4f46e5; box-shadow: 0 10px 40px rgba(15, 23, 42, 0.12);',
