        ...
        <div class="flex items-center gap-4">
            <div>
                <h1 class="flex items-center gap-2 text-2xl font-bold text-white">
                    <span class="inline-flex h-5 w-5 items-center justify-center mr-2"><i class="fas fa-newspaper"></i></span>
                    博客管理
                </h1>
...
<?php if (empty($items)): ?>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div class="empty-state">
            <span class="inline-flex h-5 w-5 items-center justify-center"><i class="fas fa-file-alt"></i></span>
            <p>暂无博客文章</p>
                        ...
                        <tr>
                            <td>
                                <div class="flex items-center">
                                    ...
                                    <div style="width: 56px; height: 56px; background: <?= $cover ? 'url(' . asset_url($cover) . ') center/cover' : 'linear-gradient(135deg, #00d1b2 0%, #48c774 100%)' ?>; border-radius: 10px; margin-right: 1rem; flex-shrink: 0; display: flex; align-items: center; justify-content: center;">
                                        <?php if (!$cover): ?>
                                            <span class="inline-flex h-5 w-5 items-center justify-center text-white"><i class="fas fa-file-alt"></i></span>
                                        <?php endif; ?>
                                    </div>
                                    <div>
                            ...
                            <td>
                                ...
                                <span class="inline-flex items-center gap-1 rounded-full px-3 py-1 text-xs font-semibold <?= $s[1] ?>">
                                    <span class="inline-flex h-4 w-4 items-center justify-center"><i class="fas fa-<?= $s[2] ?>"></i></span>
                                    <span><?= $s[0] ?></span>
                                </span>
                            </td>
                            <td>
