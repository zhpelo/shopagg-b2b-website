...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function addMediaItem(url) {
            const exists = [].some.call(mediaContainer.querySelectorAll('input[name="images[]"]'), function(inp) {
                return inp.value === url;
            });
            if (exists) return;
 ...
 `;
        ...
        mediaContainer.addEventListener('click', (e) => {
            const removeButton = e.target.closest('.remove-media');
            if (removeButton) {
