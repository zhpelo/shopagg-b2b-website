                            ...
                            <td>
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <?php if ($user['id'] !== (int)$_SESSION['admin_user_id']): ?>
                                        <button type="button" data-post-action="<?= url('/admin/staff/delete') ?>" data-post-payload="<?= h(json_encode(['id' => (int)$user['id']])) ?>" class="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-rose-50 text-rose-600 transition hover:bg-rose-100" data-confirm-message="确定要删除该员工吗？此操作不可恢复。">
